...
export const TextAreaInput: React.FC<types.TextAreaInputType> = ({
  value,
  texts,
  innerRef,
  onChange,
  ...
  const handleBlur = () => {
    ...
    if (invalid) {
      result = {
        ...
        error_message:
          texts?.validate ||
          i18n.t('error_messages_invalidTextArea', {
  ...
  const textAreaClassName = classname(inputClassName, 'textAreaClass')
